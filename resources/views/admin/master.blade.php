                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1-2" aria-controls="submenu-1-2"><i class="fas fa-fw fa-file"></i> Category</a>
                                <div id="submenu-1-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('category.addCategory') }}">Add Category</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('category.viewCategory') }}">Manage Category</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('category.trashedCategory') }}">Delete</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1-3" aria-controls="submenu-1-3"><i class="fas fa-fw fa-file"></i>Sub Category</a>
                                <div id="submenu-1-3" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('subcategory.addSubCategory') }}">Add Sub Category</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('subcategory.viewSubCategory') }}">Manage Sub Category</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('subcategory.trashedSubCategory') }}">Delete</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1-4" aria-controls="submenu-1-4"><i class="fas fa-fw fa-file"></i>Product</a>
                                <div id="submenu-1-4" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('product.addProduct') }}">Add Product</a>
                                            <a class="nav-link" href="{{ route('product.viewProduct') }}">View Product</a>
                                            <a class="nav-link" href="{{ route('product.manageTrashProduct') }}">Delete</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1-5" aria-controls="submenu-1-4"><i class="fas fa-fw fa-file"></i>Banner</a>
                                <div id="submenu-1-5" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('banner.addBanner') }}">Add Banner</a>
                                            <a class="nav-link" href="{{ route('banner.viewBanner') }}">View banner</a>
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">@yield('linkItem')</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
