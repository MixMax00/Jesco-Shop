                        ...
                        <div
                            ...
                            <div class="show-case">
                                <div class="hero-slide-image">
                                    <img src="{{ asset('front-end') }}/assets/images/slider-image/slider-2-1.png" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container align-self-center">
                    <div class="row">
                        ...
                        <div
                            ...
                            <div class="show-case">
                                <div class="hero-slide-image">
                                    <img src="{{ asset('front-end') }}/assets/images/slider-image/slider-2-2.png" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-6">
                ...
                <div class="single-feature">
                    <div class="feature-icon">
                        <img src="{{ asset('front-end') }}/assets/images/icons/1.png" alt="">
                    </div>
            ...
            <div class="col-lg-4 col-md-6 mb-md-30px mb-lm-30px mt-lm-30px">
                <div class="single-feature">
                    <div class="feature-icon">
                        <img src="{{ asset('front-end') }}/assets/images/icons/2.png" alt="">
                    </div>
                    <div class="feature-content">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-feature">
                    <div class="feature-icon">
                        <img src="{{ asset('front-end') }}/assets/images/icons/3.png" alt="">
                    </div>
                    <div class="feature-content">
                        ...
                        <div class="row">
                          ...
                          @foreach($all_product as $product)
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        <a href="{{ route('product.single',['id'=>$product->id,'slug'=>$product->slug]) }}" class="image">
                                            <img src="{{ asset('uploads/product-image')}}/{{ $product->product_image }}" alt="Product" />
                                        </a>
                                        <span class="badges">
                                            @if(Carbon\Carbon::parse($product->created_at)->diffInDays() <= 3 )
                                    ...
                                    <div class="content">
                                        ...
                                        <h5 class="title"><a href="{{ route('product.single',['id'=>$product->id,'slug'=>$product->slug]) }}">{{ $product->product_name }}
                                            </a>
                                        </h5>
                                        <span class="price">
                                          @if($product->new_price)
                                            <span class="new">TK. {{ $product->new_price }}</span>
                                            <span class="old">TK. {{ $product->old_price }}</span>
                                          @else
                                            <span class="new">TK. {{ $product->old_price }}</span>
                                          @endif
                                        </span>
                                    </div>
                                </div>
