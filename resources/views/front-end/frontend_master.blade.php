...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('front-end') }}/assets/css/vendor/vendor.min.css" />
    <link rel="stylesheet" href="{{ asset('front-end') }}/assets/css/plugins/plugins.min.css" />
    <link rel="stylesheet" href="{{ asset('front-end') }}/assets/css/style.min.css">
...
<body>
    ...
    <script src="{{ asset('front-end') }}/assets/js/plugins/plugins.min.js"></script>
