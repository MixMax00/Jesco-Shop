            ...
            <div class="row">
                <div class="col-auto align-self-center">
                    <div class="header-logo">
                        <a href="index.html"><img src="{{ asset('front-end') }}/assets/images/logo/logo.png" alt="Site Logo" /></a>
                    </div>
                </div>
...
<div id="cart" class="offcanvas offcanvas-cart">
    <div class="inner">
        <div class="head">
        ...
        <div class="body customScroll">
            <ul class="minicart-product-list">
              ...
              @foreach($viewCart as $cart)
                <li>
                    <a href="single-product.html" class="image"><img src="{{ asset('uploads/product-image') }}/{{ $cart->attributes->image }}"
                            alt="Cart product Image"></a>
                    <div class="content">
                        <a href="single-product.html" class="title">{{ $cart->name }}</a>
