            ...
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    @if($product->status == 1)
                    <a href="{{ route('product.unPublised', ['id'=>$product->id]) }}" class="btn btn-primary btn-sm">
                        <span><i class="fa fa-arrow-up"></i></span>
                    </a>
                    @else
                    <a href="{{ route('product.publised', ['id'=>$product->id]) }}" class="btn btn-warning btn-sm">
                        <span><i class="fa fa-arrow-down"></i></span>
                    </a>
                    @endif
                    <a href="{{ route('product.editProduct', ['id'=>$product->id]) }}" class="btn btn-info btn-sm">
                      <span><i class="fa fa-edit"></i></span>
                    </a>
                    <a href="{{ route('product.singleProduct', ['id'=>$product->id]) }}" class="btn btn-info btn-sm">
